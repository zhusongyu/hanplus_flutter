...
class HPAPIProvider extends HPAPI {
  ...
  @override
  Future<LoginResponseModel> login({String email, String password, VoidCallback callback}) async {
    ...
    // try {
      ResultData response = await httpManager.netFetch(
          ...
          {"User-Agent": "com.handeson.os/HanPlus/1.0.0-6 (iPhone; U; OS 12.2; en-GB)"},
          Options(
              method: "POST",
              contentType:
