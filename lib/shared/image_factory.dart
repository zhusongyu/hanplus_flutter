...
class ImageFactory {
  ...
  static final bg = Image.asset('res/assets/bg.png');
  static final iconBack = Image.asset('res/assets/iconBack.png');
  static final more = Image.asset('res/assets/moreIcon.png');
  ...
  static final tabShopCart =
      Image.asset('res/assets/tabBarIconShoppingCart.png');
